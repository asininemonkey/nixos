...

{
  ...
  services.globalprotect = {
    ...
    settings = {
      "a7.${company}.com" = {
        openconnect-args = "--servercert=pin-sha256:M4rZMoNzqfYdywqOis4RyZ1AJpdd/pOwSJzHlfylK/E="; # gnutls-cli --insecure <url> | grep --after-context 1 'Public Key PIN'
      };

      "b2.${company}.com" = {
        openconnect-args = "--servercert=pin-sha256:pu/FNcJsG8c2A4AL10egwLymA6G8w5uOSnBBkCLYQeg="; # gnutls-cli --insecure <url> | grep --after-context 1 'Public Key PIN'
      };
    };
  };
}
