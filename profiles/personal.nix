    ...
    home = {
      ...
      file = { # https://nix-community.github.io/home-manager/options.xhtml#opt-home.file
        ...
        ".zsh_aliases_work".text = ''
          alias 'mvc'='mullvad connect --wait'
          alias 'mvd'='mullvad disconnect --wait'
          alias 'mvl'='mullvad relay list'
          alias 'mvlch'='mullvad relay set location ch zrh'
          alias 'mvlgb'='mullvad relay set location gb lon'
          alias 'mvlie'='mullvad relay set location ie dub'
          alias 'mvs'='mullvad status --location -v'
        '';
