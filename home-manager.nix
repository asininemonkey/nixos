  ...
  home-manager.users.jcardoso = { config, lib, ... }: with lib.hm.gvariant; {
    ...
    home.file = { # https://nix-community.github.io/home-manager/options.xhtml#opt-home.file
      ...
      ".zsh_aliases_common".text = ''
        ...
        alias 'tshome'='sudo tailscale up --accept-routes --exit-node intel-nuc --reset --ssh'
        alias 'tsmch'='sudo tailscale up --accept-routes --exit-node ch-zrh-wg-001.mullvad.ts.net --reset --ssh'
        alias 'tsmgb'='sudo tailscale up --accept-routes --exit-node gb-glw-wg-001.mullvad.ts.net --reset --ssh'
        alias 'tsmie'='sudo tailscale up --accept-routes --exit-node ie-dub-wg-101.mullvad.ts.net --reset --ssh'
        alias 'tsreset'='sudo tailscale up --accept-routes --advertise-exit-node --reset --ssh'
        alias 'tswork'='sudo tailscale up --accept-routes --exit-node msi-pro-work --reset --ssh'
      '';
