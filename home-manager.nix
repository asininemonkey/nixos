  ...
  home-manager.users.jcardoso = { lib, ... }: with lib.hm.gvariant; {
    ...
    home.file = { # https://nix-community.github.io/home-manager/options.xhtml#opt-home.file
      ...
      ".config/git/allowed_signers".text = ''
        65740649+asininemonkey@users.noreply.github.com ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIQowLl5Bzn87ig+Gs7Ze5kWODRTdHiD+V8sOCwOx16Z personal
        65740649+asininemonkey@users.noreply.github.com ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBEe5fSnP76m3ui0RhuSLrGE6C1J99nFkWn7+lH/Wdpi work
      '';
